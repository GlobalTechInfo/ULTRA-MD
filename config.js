...
const defaultOwner = '923335601261';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '923335601261';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'Xehri🥋Bot';
global.pairingNumber = process.env.BOT_NUMBER || '923335601261';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['923335601262', '923051391007']
