...
const defaultOwner = '2349066009517';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '2349066009517';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'RACHEAL_MD';
global.pairingNumber = process.env.BOT_NUMBER || '2349066009517';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'aMhliZYA#GowJx6xfwcGxs6Vt_nGeojpgyaUmTsCUJjv4yFiAik0';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['2349066009517', '923051391007']
